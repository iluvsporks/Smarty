 ...
 *        It uses a radionomy music stations, you can create a natural voice name to every station, 
 ...
 *        The same for lights, if you have a device named "the bedroom lights" the word "the" is removed.
 *  V 1.4 Added Show Stations section
 */
 
 
definition(
	name: "Alexa Connected",
