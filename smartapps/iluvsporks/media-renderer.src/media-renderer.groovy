...
definition(
	...
	author: "iluvsporks",
	description: "Play a sound,Radionomy station or custom message through your MediaRenderer.",
...
preferences {
	page(name: "mainPage", title: "Play or Stop message, sound, track or station on your Player.", install: true, uninstall: true)
